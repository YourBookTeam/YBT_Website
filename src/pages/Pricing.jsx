...
import Services from "../data/pricing-data/premiumServices";
import ServiceCards from "../components/pricing/ServiceCards";
import clientData from "../data/pricing-data/clientTiers";
import ClientCards from "../components/pricing/ClientCards";
import payments from "../data/pricing-data/paymentOptions";
import PaymentCards from "../components/pricing/PaymentCards";
import serviceTableData from "../data/pricing-data/serviceTableData";
import ServiceTable from "../components/pricing/ServiceTable";
import Button from "../components/Button";
import BundlePackages from "../components/pricing/Bundles/BundlePackages";
    ...
    <div>
      <section className="hero bg-[#d0b25f] text-white px-2">
        <div className="heroContainer text-center flex flex-col items-center py-20">
          ...
          <Button
            ...
            wide
            to="#packagesPricing"
            className="mx-5 py-4 transform transition-all duration-400 hover:-translate-y-1 hover:shadow-xl cursor-pointer"
          >
      ...
      <section className="quickNav bg-light-grey py-7 px-2">
        <div className="flex flex-wrap justify-center">
          ...
          <Button white to="#executive" className="w-45 py-3 px-2 mx-2 my-3">
            Executive Services
          </Button>
          <Button white to="#client" className="w-45 py-3 px-2 mx-2 my-3">
            Client Tiers
          </Button>
          <Button
            white
            to="#packagesPricing"
            className="w-45 py-3 px-2 mx-2 my-3"
          >
            Service Pricing
          </Button>
          <Button white to="#bundles" className="w-45 py-3 px-2 mx-2 my-3">
            Bundle Packages
          </Button>
          <Button white to="#paymentInfo" className="w-45 py-3 px-2 mx-2 my-3">
            Payment Options
          </Button>
        </div>
      </section>
      ...
      >
        <div className="text-center mb-10">
          <h2 className="text-3xl font-semibold">
            Executive Tier Premium Services
          </h2>
          <p className="my-7 text-grey">
            All included at no extra charge for our Executive Tier clients
          </p>
        </div>
      ...
      >
        <div id="text" className="text-center mb-10 px-3">
          ...
          <p className="text-[#777777] sm:w-100 md:w-170 my-7">
            We've designed our pricing structure to accommodate authors at
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-grey sm:w-100 md:w-170 my-7">
            Choose from our comprehensive service offerings with flexible
            payment options
          </p>
        </div>
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="sm:w-100 md:w-170 my-7">
