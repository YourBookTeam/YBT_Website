...
function BundleCard({ card }){
    let gradient = "";
    if(card.title === "Executive") gradient = "bg-gradient-to-r from-gold to-[#8A6D17]";
    else if(card.title === "Professional") gradient = "bg-gradient-to-r from-[#CEB260] to-[#BBA156]";
    else if(card.title === "Emerging") gradient = "bg-gradient-to-r from-[#D4C18B] to-[#CEB260]";
    ...
    return(
        <div className="cards flex flex-col items-center">
            ...
            <div className="exec-card w-[95%] h-auto bg-white shadow-sm flex flex-col text-black rounded-b-lg">
                <div className={`title text-white w-full h-full rounded-t-lg p-7 flex flex-col gap-2 justify-center item-center text-center ${gradient}`}>
