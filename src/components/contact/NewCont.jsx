...
import SuccessModal from "./ContactNew";
...
const ContactForms = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Local development - show modal immediately for testing
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full pb-10 px-5 xl:p-0">
      ...
      >
        ...
        {/* Error message - kept minimal styling */}
        {submitError && (
        ...
        {/* Submit button - YOUR ORIGINAL STYLES PRESERVED */}
        <button
          type="submit"
