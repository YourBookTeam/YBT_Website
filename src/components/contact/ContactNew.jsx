...
const SuccessModal = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg max-w-md w-full p-4 sm:p-6 md:p-8 relative animate-fade-in">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        {/* Success message */}
        <h2 className="text-xl xl:text-3xl font-bold text-center mb-3">
          Message Sent Successfully!
        </h2>
        <p className="max-w-sm text-sm text-gray-600 text-center mb-6">
        ...
        <div className="text-center">
          <button
            onClick={onClose}
            className="bg-hero-black text-white px-6 py-3 rounded-md font-medium text-base hover:bg-gray-800 transition-colors"
          >
            Got it!
          </button>
        </div>
