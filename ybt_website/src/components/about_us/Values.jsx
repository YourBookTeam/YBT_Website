    ...
    ">
      <div className="text-4xl sm:text-5xl">Our Core Values</div>
        ...
        ">
            ...
            <FaHandshakeAngle className="shrink-0 text-gold size-18 sm:size-30 md:size-35"/>
            <div className="text-center">Collaboration</div>
            </div>
            <div className="flex flex-col items-center">
            <FaScaleBalanced className="shrink-0 text-gold size-18 sm:size-30 md:size-35"/>
            <div className="text-center">Integrity</div>
            </div>
            <div className="flex flex-col items-center">
            <FaUsersViewfinder className="shrink-0 text-gold size-18 sm:size-30 md:size-35"/>
        ...
        ">
            <div className="flex flex-col items-center">
            <FaHeart className="shrink-0 text-gold size-18 sm:size-30 md:size-35"/>
            <div className="text-center">Heart</div>
            </div>
            <div className="flex flex-col items-center">
            <FaCrown className="shrink-0 text-gold size-18 sm:size-30 md:size-35"/>
