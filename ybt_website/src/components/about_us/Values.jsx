  ...
  return (
    ...
    ">
        ...
        ">
            ...
            <FaHandshakeAngle className="shrink-0 text-gold size-20"/>
            <div className="text-xl">Collaboration</div>
            </div>
            <div className="flex flex-col items-center">
            <FaScaleBalanced className="shrink-0 text-gold size-20"/>
            <div className="text-xl">Integrity</div>
            </div>
            <div className="flex flex-col items-center">
            <FaUsersViewfinder className="shrink-0 text-gold size-20"/>
        ...
        ">
            <div className="flex flex-col items-center">
            <FaHeart className="shrink-0 text-gold size-20"/>
            <div className="text-xl">Heart</div>
            </div>
            <div className="flex flex-col items-center">
            <FaCrown className="shrink-0 text-gold size-20"/>
