          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-5 gap-4 items-center">
              <div className="col-span-2 text-white text-xl md:text-2xl text-right whitespace-nowrap">
                <span className="text-gold font-bold text-3xl">10% of</span> the final project fee
              </div>
              ...
              <div className="col-span-2 text-white text-xl md:text-2xl text-left whitespace-nowrap">
                <span className="text-gold font-bold text-3xl">10% off</span>{" "} your own custom book project
              </div>
            </div>
